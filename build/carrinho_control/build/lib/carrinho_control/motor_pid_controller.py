...
class PidController(Node):
    def __init__(self):
        ...
        self.declare_parameter('feedback_stale_sec', 0.5)  # (2) watchdog de dado parado
        ...
        self.declare_parameter('servo_correction_limit', 2.0)  # rad/s
        self.declare_parameter('servo_output_limit', 3.0)      # (4) clamp final, rad/s
